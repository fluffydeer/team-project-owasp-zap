...
public abstract class HttpMethodBase implements HttpMethod {
    ...
    * a recoverable exception. */
     ...
     *        this HTTP method
     *
     * @throws IOException if an I/O (transport) error occurs. Some transport org.zaproxy.zap.extension.policyRuleVerifier.exceptions
     *                     can be recovered from.
     * @throws HttpException  if a protocol exception occurs. Usually protocol org.zaproxy.zap.extension.policyRuleVerifier.exceptions
     ...
     * 
     * Returns the number of "recoverable" org.zaproxy.zap.extension.policyRuleVerifier.exceptions thrown and handled, to
     * allow for monitoring the quality of the connection.
     *
     * @return The number of recoverable org.zaproxy.zap.extension.policyRuleVerifier.exceptions handled by the method.
     */
    @Deprecated
