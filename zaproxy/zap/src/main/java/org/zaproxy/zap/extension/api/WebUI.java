...
public class WebUI {
    ...
    private API api;
    private boolean isDevTestNonce = false; // Manually change here to test nonces with the web org.zaproxy.zap.extension.policyRuleVerifier.UI
    ...
    private void appendElements(
        ...
        for (ApiElement element : elementList) {
            ...
            if (Constant.messages.containsKey(descTag)) {
                ...
                // Uncomment to see what tags are missing via the org.zaproxy.zap.extension.policyRuleVerifier.UI
                // sb.append(descTag);
            }
            sb.append("</td>");
    ...
    public String handleRequest(
            ...
            throws ApiException {
        // Generate HTML org.zaproxy.zap.extension.policyRuleVerifier.UI
