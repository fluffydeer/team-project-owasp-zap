...
public class ExtensionHelp extends ExtensionAdaptor {
    ...
    /**
     * The {@code ActionListener} to show the help dialogue (with contents matching the focused org.zaproxy.zap.extension.policyRuleVerifier.UI
    ...
    */
    ...
    /**
     * An {@code AddOnInstallationStatusListener} responsible to enabled/disable help org.zaproxy.zap.extension.policyRuleVerifier.UI components
