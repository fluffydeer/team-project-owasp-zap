...
public interface ScriptUI {
     ...
     *
     * <p>The org.zaproxy.zap.extension.policyRuleVerifier.UI should display the contents of the selected script if it's targeting the added
     * engine.
     *
     ...
     *
     * <p>The org.zaproxy.zap.extension.policyRuleVerifier.UI should clear the contents of the selected script if it's targeting the removed
     * engine.
     *
     * @param scriptEngineWrapper the engine that was removed
     * @since 2.4.0
