...
public class ZapHeadMethod extends EntityEnclosingMethod {
     ...
     * @throws IOException if an I/O (transport) error occurs. Some transport org.zaproxy.zap.extension.policyRuleVerifier.exceptions can be
     *     recovered from.
     * @throws HttpException if a protocol exception occurs. Usually protocol org.zaproxy.zap.extension.policyRuleVerifier.exceptions cannot be
     *     recovered from.
     * @see #readResponse
