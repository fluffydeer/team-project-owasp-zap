 ...
 * clean any references to org.zaproxy.zap.extension.policyRuleVerifier.UI components).
 *
 * @since 2.3.0
...
public interface ExtensionPopupMenuComponent {
     ...
     *
     * <p>Can be used to free any resources no longer needed (e.g. references to org.zaproxy.zap.extension.policyRuleVerifier.UI components)
