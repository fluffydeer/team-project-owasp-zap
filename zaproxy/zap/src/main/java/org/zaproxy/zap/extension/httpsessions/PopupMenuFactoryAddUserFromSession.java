...
public class PopupMenuFactoryAddUserFromSession extends PopupContextMenuItemFactory {
    ...
    protected class PopupMenuAddUserFromSession extends ExtensionPopupMenuItem {
        ...
        public void performAction() {
            // Manually create the org.zaproxy.zap.extension.policyRuleVerifier.UI shared contexts so any modifications are done
            // on an org.zaproxy.zap.extension.policyRuleVerifier.UI shared Context, so changes can be undone by pressing Cancel
            ...
            // Do the work/changes on the org.zaproxy.zap.extension.policyRuleVerifier.UI shared context
            ...
            // Show the session dialog without recreating org.zaproxy.zap.extension.policyRuleVerifier.UI Shared contexts
            // NOTE: First init the panels of the dialog so old users data gets loaded and just then
            // update the users
            // from the org.zaproxy.zap.extension.policyRuleVerifier.UI data model, otherwise the 'real' users from the non-shared context would
            // be loaded
            ...
            View.getSingleton()
                    .showSessionDialog(
                            ...
                            new Runnable() {
                                ...
                                @Override
                                public void run() {
                                    // Removing the users from the 'shared context' (the org.zaproxy.zap.extension.policyRuleVerifier.UI) will
