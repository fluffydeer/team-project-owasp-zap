                    ...
                    public PopupMenuItemContext getContextMenu(Context context, String parentMenu) {
                        return new PopupMenuItemContext(
                            ...
                            public void performAction(SiteNode sn) {
                                // Manually create the org.zaproxy.zap.extension.policyRuleVerifier.UI shared contexts so any modifications are
                                // done
                                // on an org.zaproxy.zap.extension.policyRuleVerifier.UI shared Context, so changes can be undone by pressing
                                // Cancel
                                ...
                                if (isTypeForMethod(this.getContext().getAuthenticationMethod())) {
                                    ...
                                    // from the org.zaproxy.zap.extension.policyRuleVerifier.UI data model, otherwise the 'real' users from the
                                            ...
                                            .showSessionDialog(
                                                    ...
                                                    new Runnable() {
                                                        ...
                                                        public void run() {
                                                            ...
                                                            // context' (the org.zaproxy.zap.extension.policyRuleVerifier.UI)
