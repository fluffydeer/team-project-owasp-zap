...
public class ZAP {
     ...
     * the tasks specified by the parameters daemon: a single process with no Swing org.zaproxy.zap.extension.policyRuleVerifier.UI, typically
     * run as a background process desktop: a Swing based desktop tool (which is how is originated,
     * as a fork of Paros Proxy) zaas: a highly scalable distributed system with a web based org.zaproxy.zap.extension.policyRuleVerifier.UI, aka
