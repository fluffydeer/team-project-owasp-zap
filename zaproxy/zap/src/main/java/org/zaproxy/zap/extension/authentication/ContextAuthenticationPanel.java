...
public class ContextAuthenticationPanel extends AbstractContextPropertiesPanel {
    ...
    public void initContextData(Session session, Context uiSharedContext) {
        ...
        // If something was already configured, find the type and set the org.zaproxy.zap.extension.policyRuleVerifier.UI accordingly
        if (selectedAuthenticationMethod != null) {
    ...
    public void saveContextData(Session session) throws Exception {
        ...
        // reflected in the org.zaproxy.zap.extension.policyRuleVerifier.UI
