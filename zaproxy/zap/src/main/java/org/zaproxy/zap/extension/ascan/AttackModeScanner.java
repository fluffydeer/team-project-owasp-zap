...
public class AttackModeScanner implements EventConsumer {
     ...
     *
     * @return the {@code ScanStatus}, or {@code null} if there's no view/org.zaproxy.zap.extension.policyRuleVerifier.UI.
     */
    ...
    private void updateCount() {
        ...
        if (now - this.lastUpdated > 200) {
            // Dont update too frequently, eg using the spider could hammer the org.zaproxy.zap.extension.policyRuleVerifier.UI unnecessarily
