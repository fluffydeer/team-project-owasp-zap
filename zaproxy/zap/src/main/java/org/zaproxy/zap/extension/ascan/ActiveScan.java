...
public class ActiveScan extends org.parosproxy.paros.core.scanner.Scanner
    ...
    public void start(Target target) {
        ...
        if (View.isInitialised()) {
            ...
            // For now this is only supported in the desktop org.zaproxy.zap.extension.policyRuleVerifier.UI
    ...
    public void notifyNewMessage(final HttpMessage msg) {
        ...
        if (hRef != null && View.isInitialised()) {
            // Very large lists significantly impact the org.zaproxy.zap.extension.policyRuleVerifier.UI responsiveness
