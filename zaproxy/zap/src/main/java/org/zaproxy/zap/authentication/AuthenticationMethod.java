...
public abstract class AuthenticationMethod {
     ...
     * method, org.zaproxy.zap.extension.policyRuleVerifier.UI elements can be marked accordingly.Description
     */
    public void onMethodPersisted() {}

    /**
     * Called when the Authentication Method is discarded from/not used in a Context. For example,
     * in this method, org.zaproxy.zap.extension.policyRuleVerifier.UI elements can be (un)marked accordingly.
     */
