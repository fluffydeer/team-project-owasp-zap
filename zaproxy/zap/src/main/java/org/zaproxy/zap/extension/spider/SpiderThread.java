 ...
 * ScanThread, it also handles the update of the graphical org.zaproxy.zap.extension.policyRuleVerifier.UI and any other "extension-level"
 * required actions.
 */
public class SpiderThread extends ScanThread implements SpiderListener {
    ...
    private void startSpider() {
        ...
        // to manipulate the org.zaproxy.zap.extension.policyRuleVerifier.UI accordingly
