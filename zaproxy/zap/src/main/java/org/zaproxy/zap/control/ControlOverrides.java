...
public class ControlOverrides {
    ...
    public String getProxyHost() {
        if (proxyHost != null && proxyHost.length() == 0) {
            // Treat an empty string as the 'all org.zaproxy.zap.extension.policyRuleVerifier.interfaces' address (like the org.zaproxy.zap.extension.policyRuleVerifier.UI does)
            return "0.0.0.0";
        }
        return proxyHost;
    }
