...
// ZAP: 2012/04/24 Changed the method destroyAllExtension to catch org.zaproxy.zap.extension.policyRuleVerifier.exceptions.
    ...
    private void hookAllExtension(double progressFactor) {
        ...
        if (hasView()) {
            try {
                ...
                logger.warn("An error occurred while updating the org.zaproxy.zap.extension.policyRuleVerifier.UI:", e);
            }
        }
    }
