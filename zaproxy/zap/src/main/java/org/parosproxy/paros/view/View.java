...
// ZAP: 2016/10/26 Create org.zaproxy.zap.extension.policyRuleVerifier.UI shared context in the session dialogue when adding a context
...
public class View implements ViewDelegate {
    ...
    /**
     * If true then the org.zaproxy.zap.extension.policyRuleVerifier.UI can request focus from other applications, if false then it should not
     */
     ...
     * that panel. If {@code recreateUISharedContexts} is {@code true}, any old org.zaproxy.zap.extension.policyRuleVerifier.UI shared contexts
     ...
     * @param recreateUISharedContexts if true, any old org.zaproxy.zap.extension.policyRuleVerifier.UI shared contexts are discarded and new
     ...
     * If true then the org.zaproxy.zap.extension.policyRuleVerifier.UI can request focus from other applications, if false then it should not
     *
     * @return true if the org.zaproxy.zap.extension.policyRuleVerifier.UI can request focus from other applications
     * @since 2.8.0
     */
    ...
    /**
     * Set whether the org.zaproxy.zap.extension.policyRuleVerifier.UI can request focus from other applications
     *
     * @param canGetFocus if true then the org.zaproxy.zap.extension.policyRuleVerifier.UI can request focus from other applications, otherwise
     *     it should not
     * @since 2.8.0
     */
