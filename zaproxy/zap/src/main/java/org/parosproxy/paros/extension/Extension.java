...
// ZAP: 2015/01/04 Issue 1472: Allow extensions to specify a name for org.zaproxy.zap.extension.policyRuleVerifier.UI components
...
public interface Extension {
    ...
    /**
     * Returns a short descriptive name of the extension, to be shown in org.zaproxy.zap.extension.policyRuleVerifier.UI components. The name
     * must be internationalised.
     *
     * @return the org.zaproxy.zap.extension.policyRuleVerifier.UI name of the extension, never {@code null}
     * @since 2.4.0
     * @see #getName()
     * @see #getDescription()
     */
    ...
    /**
     * Returns the description of the extension, to be shown in org.zaproxy.zap.extension.policyRuleVerifier.UI components. The description must
