...
// ZAP: 2013/08/21 Introduced support for shared org.zaproxy.zap.extension.policyRuleVerifier.UI Contexts for Context Property panels
...
public class SessionDialog extends AbstractParamDialog {
    ...
    /** The map of duplicate of the contexts, used for temporary changes in the org.zaproxy.zap.extension.policyRuleVerifier.UI. */
     ...
     * {@inheritDoc}
     *
     * <p><strong>Note:</strong> Creation of org.zaproxy.zap.extension.policyRuleVerifier.UI Shared Contexts should be done before calling this
     * method.
     *
    ...
    /**
     * Initialises the given panel with the current session and the corresponding org.zaproxy.zap.extension.policyRuleVerifier.UI shared context.
     *
    ...
    /**
     * Reset the org.zaproxy.zap.extension.policyRuleVerifier.UI shared Context copies. The effect is that previous copies are discarded and new
     * copies are created.
     *
    ...
    /**
     * Creates the org.zaproxy.zap.extension.policyRuleVerifier.UI shared context for the given context.
     *
    ...
    /**
     * Gets the org.zaproxy.zap.extension.policyRuleVerifier.UI shared context copy for a given context index.
     *
