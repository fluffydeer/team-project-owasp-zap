...
// ZAP: 2014/01/22 Add the possibility to bound the proxy to all org.zaproxy.zap.extension.policyRuleVerifier.interfaces if null IP address has
// been set
...
public class ProxyServerSSL extends ProxyServer {
    ...
    protected ServerSocket createServerSocket(String ip, int port)
        ...
        // ZAP: added the possibility to bound to all org.zaproxy.zap.extension.policyRuleVerifier.interfaces (using null as InetAddress)
