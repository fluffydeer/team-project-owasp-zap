...
public class VariantCustom implements Variant {
    ...
    public VariantCustom(ScriptWrapper wrapper, ExtensionScript extension) {
        ...
        if (wrapper != null && extension != null && wrapper.isEnabled()) {
            try {
                ...
                // implementations
                // might throw other org.zaproxy.zap.extension.policyRuleVerifier.exceptions on script errors (e.g.
    ...
    public void setMessage(HttpMessage msg) {
        try {
            ...
            // might
            // throw other org.zaproxy.zap.extension.policyRuleVerifier.exceptions on script errors (e.g.
            // jdk.nashorn.internal.runtime.ECMAException)
