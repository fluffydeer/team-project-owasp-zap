...
public class SiteMapPanel extends AbstractPanel {
    ...
    /**
     * Returns the Context which is selected in the Site Map panel of the org.zaproxy.zap.extension.policyRuleVerifier.UI or {@code null} if
     * nothing is selected or the selection is the root node.
     *
     * @return Context the context which is selected in the org.zaproxy.zap.extension.policyRuleVerifier.UI
     * @since 2.7.0
     */
    ...
    /**
     * Returns the List of Context selected in the Site Map panel of the org.zaproxy.zap.extension.policyRuleVerifier.UI or an empty List if
     * nothing is selected or the selection is the root node.
     *
     * @return List of Context selected in the org.zaproxy.zap.extension.policyRuleVerifier.UI
