...
// ZAP: 2015/07/17 Show stack trace of the org.zaproxy.zap.extension.policyRuleVerifier.exceptions on proxy errors
...
public class ProxyThread implements Runnable {
    ...
    /**
     * Tells whether or not the given {@code address} belongs to any of the network org.zaproxy.zap.extension.policyRuleVerifier.interfaces.
     *
     * @param address the address that will be checked
     * @return {@code true} if the address belongs to any of the network org.zaproxy.zap.extension.policyRuleVerifier.interfaces, {@code false}
     *     otherwise.
